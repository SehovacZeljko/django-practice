...
# Example of resolving circular relationsship: featured_product = models.ForeignKey('Product', on_delete=models.SET_NULL, null=True, related_name='+')
...
# This is example of one to one relationship!!
...
# This is example of one to many relationship beteen two models!!
class Address(models.Model):
    street = models.CharField(max_length=255)
    city = models.CharField(max_length=255)
